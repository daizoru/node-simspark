...
(function() {
  var inspect, pretty, r1, r2, r3, sexp;

  inspect = require('util').inspect;

  pretty = function(x) {
    return inspect(x, false, 20, true);
  };
